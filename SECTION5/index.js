// console.log("Random Number from 0 to 1")
// console.log("First Number: " + Math.random());
// console.log("Second Number: " + Math.random());
// console.log("====================");

// console.log("Random Number in Array");
// console.log("Array = [2, 5, ,6, 9, 10]");
// let arr = [2, 5, 6, 9 ,10];
// let randomNumber = arr[Math.floor(Math.random()* arr.length)];
// let randomNumber2 = arr[Math.floor(Math.random())];
...
// let listQuizz = [];
// let q1 = {
//   question: "How to name a variable correctly in Js?",
//   userChoice: [
//     "A. 22ThanhCong",
//     "B. MindX@gmail.com",
//     "C. break",
...
//     "C. Store data of all users",
//     "D. Direct User interaction",
//   ],
//   rightChoice: "B",
// };
// let q3 = {
//   question: "Keywords used to enter data in Js?",
//   userChoice: ["A. prompt", "B. let", "C. console.log", "D. alert"],
//   rightChoice: "A",
// };
// let q4 = {
//   question:
//     "In the following answers, which one is not a programming language?",
//   userChoice: ["A. C#", "B. CSS", "C. JavaScript", "D. Phython"],
//   rightChoice: "B",
// };
// listQuizz.push(q1);
// listQuizz.push(q2);
...
// let randomQuestions = listQuizz[Math.floor(Math.random() * listQuizz.length)];
// console.log(randomQuestions);

// let userAnswer = prompt(
//   `${randomQuestions.question}\n${randomQuestions.userChoice[0]}\n${randomQuestions.userChoice[1]}\n${randomQuestions.userChoice[2]}\n${randomQuestions.userChoice[3]}`
// );
...
// );
// for (let item in dataList.hits) {
//   console.log("Title: " + dataList.hits[item].jobTitle);
//   console.log("Salary: " + dataList.hits[item].jobSalary);
//   console.log("Location:");
//   console.log(" - " + dataList.hits[item].locations);
//   console.log("Benefits:");
//   for (let itemBenefit in dataList.hits[item].benefits) {
//     console.log(" - " + dataList.hits[item].benefits[itemBenefit].benefitValue);
//   };
//   console.log("Skills:");
//   for (let skill in dataList.hits[item].skills) {
//     console.log(" - " + dataList.hits[item].skills[skill]);
//   };
//   console.log("------------------------------------");
// };

// console.log("Basic Part 3");
// let wordList = [
//   "to",
//   "be",
//   "that",
